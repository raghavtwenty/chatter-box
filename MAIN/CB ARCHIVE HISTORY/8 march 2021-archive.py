...
#-----------HOME MENU-----------
vo_cb_wi = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/cb welcome intend.mp3'
...
vo_hc_err = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/signin hc.mp3'
vo_acc_settings_menu = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/account settings.mp3'

#-----------NOTIFICATION CENTRE-----------
vo_nc_listed_below = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/nc listed below.mp3'
...
vo_ac_active_ser = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/acc cr un active in servers.mp3'
...
vo_signin_acc_nf= r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/account not found.mp3'
...
#-----------CHAT-----------
vo_chat_menu = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/chat menu.mp3'
vo_chat_cb_un = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/enter frnd cbu.mp3'
vo_chat_listed_below = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/chats are listed below.mp3'
vo_chat_type_msg = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/type your msg here.mp3'
vo_chat_msg_sent_re = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/your msg has been sent.mp3'
vo_chat_inc_un = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/account not found.mp3'

#-----------SEARCH-----------
vo_fyf_search = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/frnd to searched.mp3'
vo_fyf_similar_search = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/account similar search.mp3'
...
vo_u_score = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/machine batting.mp3'
vo_u_out = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/user out.mp3'
vo_u_bowl_fun = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/user bowling function.mp3'
vo_m_bat = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/user batting.mp3'
vo_u_bowl = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/user bowling.mp3'
vo_m_invalid_input = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/invalid input.mp3'
vo_m_won = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/VOICE OVER/machine won.mp3'
...
def notification_centre():
    try:
        ...
        fh_read_notification=r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/NOTIFICATION CENTRE/NC_'+sin_cb_username_small+'_NOTIFICATION CENTRE.dat'
...
def security_alert_fh(sec_alert):
    fh_ncl_sa = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/NOTIFICATION CENTRE/NC_' + cad_sin_cb_username_small + '_NOTIFICATION CENTRE.dat'
    with open(fh_ncl_sa, 'ab') as notification_cl_sa:
        datetime_str_sa = str(datetime.datetime.now())
        sec_alert_message = '\n\t\t\t\t\t\t\t\t\t⚠️ SECURITY ALERT ⚠️️'
        sec_alert_msg_ncl = sec_alert
        fh_ncl_sec_alert_time = '\t\t[FROM]: CHATTER BOX Team-----[TO]:' + cad_sin_cb_username_small + '-----[DATE TIME]:' + datetime_str_sa
...
PLEASE, ENTER THE SAME PASSWORD IN BOTH THE COLUMNS⚠️''')
                   ...
                   cna_re_password=str(input('🗣RE-ENTER YOUR NEW PASSWORD:-'))
                       ...
                       insertval1=(cna_username_small,cna_name,cna_phone_number,cna_dob,cna_gender,cna_re_password)
                       mc1.execute(insertval,insertval1)
                       db.commit()

                   #-------------NOTIFICATION CENTRE------------
                       fh_ncl =r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/NOTIFICATION CENTRE/NC_'+cna_username_small+'_NOTIFICATION CENTRE.dat'
                       with open(fh_ncl,'ab') as notification_cl:
                           notification_cl_wel = '\t\t\t\t\t\t\t\t🔔'+cna_username_small+'\'s NOTIFICATION CENTRE.'
                           ...
                           print('\n🗣NOTE:-',cna_username_small,''',IS YOUR ACCOUNT USERNAME.
...
def sign_in():
    ...
    try:
        ...
        sin_cb_ch_password='SELECT ACCOUNT_PASSWORD FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(sin_cb_username_small)
...
PLEASE, RE-ENTER YOUR ACCOUNT PASSWORD⚠️''')
                ...
                sin_cb_name='SELECT CHATTER_NAME FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(sin_cb_username_small)
                ...
                for sin_cb_name2 in sin_cb_name1:
                    ...
                    ur_cb_name='SELECT CHATTER_NAME FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(sin_cb_username_small)
                    ur_cb_phone_number='SELECT CHATTER_PHONE_NUMBER FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(sin_cb_username_small)
                    ur_cb_dob='SELECT DATE_OF_BIRTH FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(sin_cb_username_small)
                    ur_cb_gender='SELECT GENDER FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(sin_cb_username_small)
                    ur_cb_password='SELECT ACCOUNT_PASSWORD FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(sin_cb_username_small)
                    ...
                    print('''▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼''',
                          '''\n🔒 YOUR USERNAME:-''',sin_cb_username_small,
...
def change_account_details():
    ...
    try:
            ...
            cad_sin_cb_ch_password='SELECT ACCOUNT_PASSWORD FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(cad_sin_cb_username_small)
...
PLEASE, RE-ENTER YOUR ACCOUNT PASSWORD CORRECTLY⚠️''')
                    ...
                    cad_sin_cb_name='SELECT CHATTER_NAME FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(cad_sin_cb_username_small)
...
[Press 6] - 🗑 DELETE YOUR ACCOUNT:-'''))
                        if cad_user_ask=='1':
                            ...
                            print('\n======= 📱 CHANGE PHONE NUMBER =======')
                            cad_cb_phone_number = 'SELECT CHATTER_PHONE_NUMBER FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(cad_sin_cb_username_small)
                            ...
                            cad_user_phone_number2=(cad_user_phone_number,cad_sin_cb_username_small)
                            ...
                            cad_cb_dob = 'SELECT DATE_OF_BIRTH FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(cad_sin_cb_username_small)
                            ...
                            print('\n======= 👦🏻👧🏻 CHANGE GENDER =======')
                            cad_cb_gender = 'SELECT GENDER FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(cad_sin_cb_username_small)
                            ...
                            cad_cb_password = 'SELECT ACCOUNT_PASSWORD FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(cad_sin_cb_username_small)
...
PLEASE, ENTER THE SAME PASSWORD IN BOTH THE COLUMNS⚠️''')
                                ...
                                cad_user_password3 = (cad_user_password1,cad_sin_cb_username_small)
                            ...
                            print('\n======= 🗑 DELETE YOUR ACCOUNT =======')
                            cad_cb_delete = 'SELECT ACCOUNT_PASSWORD FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(cad_sin_cb_username_small)
...
PLEASE, RE-ENTER YOUR ACCOUNT PASSWORD⚠️''')
                                ...
                                cad_user_delete = str(input('\n🗣ENTER YOUR ACCOUNT PASSWORD:-'))
                                 ...
                                 cad_user_delete1='DELETE FROM CHATTER_BOX_PROFILES WHERE USERNAME=\'{}\''.format(cad_sin_cb_username_small)
...
def sendchat():
     ...
     try:
         ...
         # -----------------DIRECT MESSAGE-----------------
         fh_name=r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/CHATS/CHAT FROM_'+sin_cb_username_small_str+'_TO_'+fh_fac_number+'.dat'
         ...
         fh_name_dup = r'/Users/mac/Documents/PYTHON /CHATTER BOX by raghava/CHATS/CHAT FROM_' + fh_fac_number + '_TO_' + sin_cb_username_small_str + '.dat'
...
def handcricket_with_machine():
    ...
    def user_batting():
        ...
        a = 1
        if a == 1:
            print(ur_cb_name2,',BATTING. ALLOWED CHARACTERS ARE 0 TO 5. NOT MORE THAN THAT.')
            while a == 1:
                print('=======================================')
                try:
